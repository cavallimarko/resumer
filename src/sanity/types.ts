...
// Variable: bioQuery
// Query: *[_type == "bio"][0]{  _id,  title,  subtitle,  content,  image,  skills}
...
// Variable: BIO_QUERY
// Query: *[_type == "bio"][0]{  _id,  title,  subtitle,  image,  content,  skills}
...
// Query: *[_type == "post"] {    _id,    title,    slug,    "mainImage": mainImage.asset->url,    categories[]->{ title }  }
export type HOMEPAGE_POSTS_QUERYResult = Array<{
  _id: string;
  title: string | null;
  slug: Slug | null;
